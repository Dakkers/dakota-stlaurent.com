...
export default function Navbar() {
  return (
    <header className="sticky top-0 z-50 h-[var(--navbar-height)] border-b border-[var(--line)] bg-[var(--header-bg)] px-4 backdrop-blur-lg">
      <nav className="page-wrap flex h-full flex-wrap items-center gap-x-3 gap-y-2">
